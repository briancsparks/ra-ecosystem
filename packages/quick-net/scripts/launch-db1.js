...
var   params = {
  distro        : 'ubuntu',
  sgs           : ['db', 'worldssh'],
  subnet        : `db-zone${az.toUpperCase()}`,
  InstanceType  : 't3.medium',
  az
};

params.userdata_opts = {INSTALL_DOCKER:false, INSTALL_OPS:false, INSTALL_MONGODB:true, INSTALL_AGENTS:true, INSTALL_KUBERNETES:false};
